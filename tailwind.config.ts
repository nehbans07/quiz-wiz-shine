  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        quiz: {
          legend: "hsl(var(--quiz-legend))",
          "legend-foreground": "hsl(var(--quiz-legend-foreground))",
          lamp: "hsl(var(--quiz-lamp))",
          "lamp-foreground": "hsl(var(--quiz-lamp-foreground))",
        ...
        entertainment: {
          primary: "hsl(var(--entertainment-primary))",
          secondary: "hsl(var(--entertainment-secondary))",
        },
        journalism: {
          primary: "hsl(var(--journalism-primary))",
          secondary: "hsl(var(--journalism-secondary))",
        },
        sidebar: {
